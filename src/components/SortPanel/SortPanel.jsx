  ...
  return (
    <S.Container>
      <S.FilterContainer>
        ...
        <S.FilterButton className="active">Phổ Biến</S.FilterButton>
        <S.FilterButton>Mới nhất</S.FilterButton>
        <S.FilterButton>Bán chạy</S.FilterButton>
        <S.SelectPrice>
      ...
      <S.FilterPagination>
        <S.PageController>
          <S.CurrentPageTitle>1</S.CurrentPageTitle>
          <S.AllPageTitle>/100</S.AllPageTitle>
        </S.PageController>
